...
if vim.fn.has("mac") == 1 then
	WORKSPACE_PATH = home .. "/nvim-dap/workspace/"
	CONFIG = "mac"
...
local root_markers = { ".git", "mvnw", "gradlew", "pom.xml", "build.gradle", ".mvn" }
		...
		java = {
			...
			configuration = {
				...
				runtimes = {
					{
						name = "JavaSE-17",
						path = "/Users/aaron/Library/Java/JavaVirtualMachines/openjdk-17.0.2/Contents/Home"
					},
				},
			},
			maven = {
...
map("n", "<leader>tnm", jdtls.test_nearest_method, "Test Method")
map("n", "<leader>tc", jdtls.test_class, "Test Class")
map("n", "<leader>uc", "<Cmd>JdtUpdateConfig<CR>", "Update Config")
